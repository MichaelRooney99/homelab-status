...
// pattern of keeping helpers private — this exact class of derivation
// logic is duplicated three times across this codebase (here,
// proxy/src/poller.ts, proxy/src/nudge.ts) specifically because it's
// small enough that shared tooling wasn't worth it, and that kind of
// duplication is exactly what silently drifted apart in a real
// past bug involving mismatched metric job names. Testing this
// canonical copy doesn't automatically protect the other two, but
