...
// just the minimal config to point it at the right files.
export default defineConfig({
  test: {
    ...
    // as "a test failed." That's correct once real proxy-side test
    // files exist; before they did, it would have failed every CI run
    // for a reason that had nothing to do with anything actually being
    // broken.
